...
const PAIN_POINTS = [
  {
    label: "Verified stay",
    text: "You've compared eleven housing sites and still don't know which listings are real.",
  },
  {
    label: "Budget",
    text: "No one tells you what rent, food, and transport actually cost in a city you've never lived in.",
  },
  {
    label: "People",
    text: "Your future classmates are scattered across five WhatsApp groups you joined out of panic.",
  },
];
...
const STEPS = [
  {
    ...
    text: "Your university, your program, your move-in window, your budget.",
  },
  {
    n: "02",
    title: "Get matched",
    text: "A short, AI-picked list of verified rooms and roommates who actually fit your budget and habits.",
  },
  {
    n: "03",
    title: "Move in with confidence",
    text: "No scrambling on arrival day. It's already sorted before your flight lands.",
  },
];
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20 pt-8 md:pb-28 md:pt-16">
        <div className="grid items-center gap-14 md:grid-cols-2">
          <div className="rise-in">
            ...
            <h1 className="font-display text-4xl leading-[1.08] text-ink sm:text-5xl md:text-[3.4rem]">
              Your boarding pass
              <br />
              to campus life.
            </h1>
            <p className="mt-6 max-w-md text-lg leading-relaxed text-ink/70">
              You got the admit. Now find a verified room and a roommate who
              won&apos;t drive you up the wall &mdash; before you even land.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a
                href="#waitlist"
                className="rounded-full bg-marigold px-7 py-3 text-sm font-semibold text-ink shadow-sm transition hover:brightness-95"
              >
                Reserve my seat
              </a>
          ...
          {/* Boarding pass / ticket visual */}
          <div className="rise-in [animation-delay:150ms] [animation-fill-mode:backwards]">
            <div className="relative mx-auto max-w-sm overflow-hidden rounded-2xl bg-ink text-parchment shadow-2xl shadow-ink/20">
              ...
              <div className="px-6 py-6">
                <div className="flex items-center justify-between">
                  ...
                  <svg
                    viewBox="0 0 120 24"
                    className="mx-3 h-5 w-24 shrink-0"
                    fill="none"
                  >
                    <path
                      d="M2 12h108"
                ...
                <div className="mt-6 grid grid-cols-3 gap-4 border-t border-dashed border-parchment/25 pt-5">
                  <div>
                    <p className="font-mono text-[9px] uppercase tracking-[0.15em] text-parchment/50">
                      Program
                    </p>
              ...
              <div className="flex items-center justify-between px-6 pb-5 pt-1">
                <span className="font-mono text-[10px] text-parchment/50">
                  PNR CSAI&ndash;2027
                </span>
                <span className="font-mono text-[10px] text-parchment/50">
      ...
      <section className="border-y border-ink/10 bg-paper">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          <h2 className="max-w-lg font-display text-2xl text-ink sm:text-3xl">
            Sound familiar?
          </h2>
          <div className="mt-10 grid gap-5 sm:grid-cols-3">
            {PAIN_POINTS.map((p) => (
              <div
                key={p.label}
                className="rounded-xl border border-ink/10 bg-parchment p-6 shadow-sm"
              >
      ...
      <section className="border-y border-ink/10 bg-ink text-parchment">
        <div className="mx-auto max-w-3xl px-6 py-16 text-center md:py-20">
          ...
          <p className="mx-auto mt-5 max-w-xl text-[15px] leading-relaxed text-parchment/70">
            Every relocating student is drowning in disconnected apps
            already. We&apos;re starting narrow on purpose &mdash; solve the
            single hardest decision well, then earn the right to do more.
          </p>
        </div>
      </section>
      ...
      <section id="waitlist" className="mx-auto max-w-2xl px-6 py-20 md:py-28">
        <div className="text-center">
          <h2 className="font-display text-2xl text-ink sm:text-3xl">
            Help us validate this before we build it
          </h2>
          <p className="mt-3 text-ink/65">
            We&apos;re a small pilot testing real demand. Two minutes, and
            you&apos;ll be first in line when rooms open up.
          </p>
          {count !== null && count > 0 && (
            <p className="mt-4 font-mono text-xs uppercase tracking-[0.15em] text-mint">
              🎟️ {count} student{count === 1 ? "" : "s"} already reserved a
              seat
            </p>
          )}
        </div>
          ...
          {status === "success" ? (
            <div className="p-8 text-center">
              ...
              <p className="mt-2 text-sm text-ink/65">
                We&apos;ll email {email} the moment your city opens up for
                the pilot.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="grid gap-5 p-8">
              {status === "duplicate" && (
                <p className="rounded-lg bg-coral/10 px-4 py-3 text-sm text-coral">
                  Looks like you&apos;re already on the list with that email.
                </p>
              )}
              {status === "error" && (
                <p className="rounded-lg bg-coral/10 px-4 py-3 text-sm text-coral">
              ...
              <label className="grid gap-1.5 text-sm">
                ...
                <input
                  ...
                  placeholder="e.g. Kolkata, Goa, Delhi"
                  className="rounded-lg border border-ink/15 px-4 py-2.5 outline-none ring-marigold/50 focus:ring-2"
                />
              </label>
              ...
              <p className="text-center font-mono text-[10px] text-ink/40">
                We respect your privacy · No payment required
              </p>
            </form>
          )}
        </div>
